...
function setup(){
 ...
 // pig1.addImage(pig1Img);
  ...
  l16.visible = false;
  l16.shapeColor = "green";

  l17 = createSprite(-640,450,25,10);
  l17.visible = false;
  l17.shapeColor = "green";
/*
  ...
  fill("blue");
  textSize(25);
  text("You are sam and your father is a farmer.He is very hardworking.He is very disappoint with you because you don't",45,150);
  text("work. He thinks you are very lazy. Now you have to prove him wrong by doing the tasks given by him and earn ",45,200);
  text("$500.",45,250);

  fill(rgb(125, 25, 112));
  textSize(30);
  text("Controls:-",30,320);
  ...
  textSize(25);
  fill("darkGreen");
  text("*your current money is visible under the clock.",50,480);
  text("*after every tasks you earn $80.",50,510);
  text("*information about each task is given on the bottom-right corner of the screen.",50,540);

  textSize(50);
  fill(rgb(75, 108, 170));
  text("Enjoy the game. Have fun!",400,600);
...
*/
 ...
 if(keyDown("down") || keyDown("s")){
  ...
  if(sam.isTouching(man1)){
    ...
    textFont("monospace");
    text("Hello i am sam.",400,290);
    text("Hello sam do you need any help?",400,330);
    text("Yes,i want tools.",400,370);
  ...
  l2.changeAnimation("carrot3",c3);
  l3.changeAnimation("carrot3",c3);
  l4.changeAnimation("carrot3",c3);
  l5.changeAnimation("carrot3",c3);
  l6.changeAnimation("carrot3",c3);
  l7.changeAnimation("carrot3",c3);
  l8.changeAnimation("carrot3",c3);
  l9.changeAnimation("carrot3",c3);
  l10.changeAnimation("carrot3",c3);
  l11.changeAnimation("carrot3",c3);
  l12.changeAnimation("carrot3",c3);
  l13.changeAnimation("carrot3",c3);
  l14.changeAnimation("carrot3",c3);
  l15.changeAnimation("carrot3",c3);
  ...
  textSize(20);
  text("Go to home and by touching each carrot Press 'C' to cut",885,580);
  text("By touching each cow press 'C' to take milk.",885,600);
 ...
 if(sam.isTouching(man2)){
  ...
  if(keyDown("T")){
    ...
    text("_____________________________________",255,315);
    text("_____________________________________________________________",255,375);
    text("____________________________________________________________",255,435);
    text("___________",255,465);
  }
